...
public class MateriaDto {
	...
	@Min(value = 20, message = "Permitido mínimo de 34 horas por matéria.")
	...
	@Min(value = 1, message = "Permitido mínimo de 1 vez ao ano.")
	@Max(value = 2, message = "Permitido máximo de 2 vezess por matéria.")
